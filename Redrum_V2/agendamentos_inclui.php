			...
			<div class="container-fluid">
				<div class="row mt-6">
					<div class="col-lg-6">
						<div class="card">
							<div class="card-body">
								<div class="card-title"><h3>Agendamentos</h3>* Campo Obrigatório</div>
								<hr>
								<form name="formulario" action="agendamentos_incluir.php" method="post">
									...
									<div class="form-group">
										...
										<input type="date" class="form-control" name="data" value="" id="input-2" maxlength="10" placeholder="dd/mm/aaaa" required>
									</div>
									<div class="form-group">
										<label for="input-2">Horário da Doação</label>
										<input type="time" class="form-control" name="hora" value="" id="input-2" maxlength="5" placeholder="hh:mm" required>
									</div>
									<div class="form-group">
										<input type="hidden" name="iddoador" value="<?php echo $codigo;?>">
